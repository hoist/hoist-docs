...
var write = function(doc) {
  ...
  //add the git link to the bottom
  var gitLink = 'https://github.com/hoist/hoist-docs/tree/master/docs' + doc.src;
  raw += "<div class='git-link' style='opacity:0.5'><b>Github URL</b><br /><a style='color:#666666' href='" + gitLink + "'>" + gitLink + "</a></div>";
