...
If you're using another language or frameowkr, either [get in touch](mailto:hello@hoist.io) about getting an SDK, or replace the SDK calls using the raw APIs. 
